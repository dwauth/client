...
module.exports = DwidClient

function DwidClient (opts) {
  if (!(this instanceof DwidClient)) return new DwidClient(opts)
...
DwidClient.prototype.register = function (opts, cb) {
  opts = opts || {}
...
DwidClient.prototype.login = function (opts, cb) {
  opts = opts || {}
...
DwidClient.prototype.logout = function (opts, cb) {
...
DwidClient.prototype.updatePassword = function (opts, cb) {
  opts = opts || {}
...
DwidClient.prototype.getLogin = function (server) {
  var self = this
...
DwidClient.prototype._getServer = function (opts) {
  opts = opts || {}
  return opts.server || this.server
}

DwidClient.prototype.secureRequest = function (opts, cb) {
  var self = this
  var server = self._getServer(opts)
...
DwidClient.prototype._request = function (opts, cb) {
